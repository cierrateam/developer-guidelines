...
<div id="js-search-input" class="docsearch-input__wrapper hidden md:block">
    ...
    <input id="docsearch-input"
        class="docsearch-input relative block h-10 transition w-full lg:w-1/2 xl:w-1/3 bg-gray-100 outline-none rounded-full text-gray-700 border border-gray-500 focus:border-blue-400 ml-auto px-4 pb-0"
    ...
    <button
        ...
        onclick="searchInput.toggle()">&times;</button>
</div>
